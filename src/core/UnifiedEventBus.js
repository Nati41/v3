/**
 * ═══════════════════════════════════════════════════════════════
 * תיעוד בעברית - UnifiedEventBus
 * ═══════════════════════════════════════════════════════════════
 *
 * מה הקובץ עושה:
 *   מערכת אירועים מרכזית מאוחדת לכל המודולים.
 *   כל תקשורת בין מודולים עוברת דרך eventBus.
 *
 * מי משתמש בקובץ:
 ...
 *
 * למה הוא קיים:
 *   מבוסס על EventBus של Mapper v3 אבל מורחב לכל המודולים.
 *   כולל מוניטור ביצועים ומצב חירום.
 * ═══════════════════════════════════════════════════════════════
 */
