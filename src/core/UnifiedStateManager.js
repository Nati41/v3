/**
 * ═══════════════════════════════════════════════════════════════
 * תיעוד בעברית - UnifiedStateManager
 * ═══════════════════════════════════════════════════════════════
 *
 * מה הקובץ עושה:
 *   ניהול מצב גלובלי מאוחד לכל המודולים בשולחן העבודה.
 *   כל שדה, ערך, היסטוריה - הכל מנוהל כאן.
 *
 * מי משתמש בקובץ:
 *   - Mapper v3, LiveFill, אינטגרציית Excel, מנוע ייצוא
 *
 * באיזה מצבים:
 *   תמיד פעיל - תשתית בסיסית
 *
 * למה הוא קיים:
 *   מקום אחד שכולם מסתמכים עליו לנתוני שדות.
 *   מבוסס על StateManager של Mapper v3 אבל מורחב לכל המודולים.
 * ═══════════════════════════════════════════════════════════════
 */
