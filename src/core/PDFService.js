/**
 * ═══════════════════════════════════════════════════════════════
 * תיעוד בעברית - PDFService
 * ═══════════════════════════════════════════════════════════════
 *
 * מה הקובץ עושה:
 *   שירות אחיד לטעינה ורינדור PDF.
 *   תומך באסטרטגיות רינדור שונות (canvas vs image)
 *   ו-cache לדפים למעבר מהיר.
 *
 * מי משתמש בקובץ:
 *   - Mapper v3, LiveFill, Mobile Fill
 *
 * באיזה מצבים:
 *   תמיד - בכל מקום שיש PDF
 *
 * למה הוא קיים:
 *   מרכז את כל לוגיקת PDF במקום אחד במקום שכל מודול יממש בעצמו.
 * ═══════════════════════════════════════════════════════════════
 */
