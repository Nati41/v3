/**
 * ═══════════════════════════════════════════════════════════════
 * תיעוד בעברית - CoordinateService
 * ═══════════════════════════════════════════════════════════════
 *
 * מה הקובץ עושה:
 *   שירות המרת קואורדינטות אחיד.
 *   ממיר בין 4 מערכות צירים: PDF נורמלי (0-1), PDF נקודות,
 *   מסך (פיקסלים), ו-CSS.
 *
 * מי משתמש בקובץ:
 *   - כל מודול שמציב אלמנטים על PDF או קורא מיקום
 *
 * באיזה מצבים:
 *   תמיד - בכל חישוב קואורדינטות
 *
 * למה הוא קיים:
 *   קואורדינטות זה הדבר הכי מבלבל בפרויקט.
 *   שירות אחד מרכזי מונע באגים של בלבול בין מערכות צירים.
 * ═══════════════════════════════════════════════════════════════
 */
