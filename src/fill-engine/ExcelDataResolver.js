/**
 * ═══════════════════════════════════════════════════════════════
 * תיעוד בעברית - ExcelDataResolver
 * ═══════════════════════════════════════════════════════════════
 *
 * מה הקובץ עושה:
 *   קורא קבצי אקסל/CSV וממיר אותם לנתוני מילוי.
 *   מתאים עמודות אקסל לשדות בתבנית המיפוי.
 *
 * איך זה עובד:
 *   - פרסור Excel/CSV → טבלת נתונים
 *   - אסטרטגיית התאמה רב-שכבתית עם ציוני ביטחון
 *   - התאמה מדויקת, נרדפות, מעורפלת, פורמט, הקשר
 *
 * מי משתמש בקובץ:
 *   - ExcelFillUI.js - ממשק ייבוא אקסל
 *   - fill-engine.js - מילוי מנתוני אקסל
 *
 * באיזה מצבים:
 *   כשהמשתמש מייבא נתונים מאקסל
 *
 * למה הוא קיים:
 *   כדי שרואי חשבון יוכלו לטעון נתוני לקוחות מאקסל
 *   ולמלא עשרות טפסים אוטומטית.
 * ═══════════════════════════════════════════════════════════════
 */
