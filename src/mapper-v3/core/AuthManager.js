/**
 * ═══════════════════════════════════════════════════════════════
 * תיעוד בעברית - AuthManager
 * ═══════════════════════════════════════════════════════════════
 *
 * מה הקובץ עושה:
 *   ניהול הרשאות גישה לכלי.
 *   שתי רמות: PUBLIC (מילוי בלבד) / AUTHORIZED (גישה מלאה למיפוי).
 *
 * איך זה עובד:
 *   - init() - אתחול (בדיקת session קיים)
 *   - authorize(code) - אימות קוד גישה
 *   - isAuthorized() - בדיקת רמת הרשאה
 *   - מונחה אירועים: LOGIN_SUCCESS, LOGIN_FAILED, LEVEL_CHANGED
 *
 * מי משתמש בקובץ:
 *   - MapperCore.js - בדיקת הרשאות בטעינה
 *   - mapper-v3.html - ממשק כניסה
 *
 * באיזה מצבים:
 *   תמיד פעיל - שולט בגישה
 * ═══════════════════════════════════════════════════════════════
 */
