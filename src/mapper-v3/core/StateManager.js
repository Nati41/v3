/**
 * ═══════════════════════════════════════════════════════════════
 * תיעוד בעברית - StateManager
 * ═══════════════════════════════════════════════════════════════
 *
 * מה הקובץ עושה:
 *   מקור אמת יחיד לכל מצב ה-Mapper.
 *   כל שדה, קבוצת רדיו, טבלה, ומצב UI - הכל כאן.
 *
 * איך זה עובד:
 *   - CRUD לשדות (הוספה, עדכון, מחיקה)
 *   - עדכונים immutable עם מעקב היסטוריה (undo/redo)
 *   - persistence דרך localStorage
 *   - ניהול קבוצות רדיו עם זרימה רב-שלבית
 *   - ניהול אזורי טבלה
 *   - ייצוא ל-Fill Engine
 *
 * מי משתמש בקובץ:
 *   כמעט כל מודול - זהו הלב של ניהול הנתונים
 *
 * באיזה מצבים:
 *   תמיד פעיל
 *
 * Singleton: export const state
 * מייצא גם: Tools, Modes, RadioGroupSteps, FlowModes
 * ═══════════════════════════════════════════════════════════════
 */
