/**
 * ═══════════════════════════════════════════════════════════════
 * תיעוד בעברית - FillEngineExporter
 * ═══════════════════════════════════════════════════════════════
 *
 * מה הקובץ עושה:
 *   מייצא את כל השדות שמופו לפורמט JSON שמנוע המילוי (Fill Engine) מבין.
 *   ממזג קואורדינטות (מ-StateManager) עם סמנטיקה (מ-AI).
 *
 * איך זה עובד:
 *   - exportForFillEngine() - ייצוא מלא
 *   - quickExport() - ייצוא מהיר
 *   - validateFillEngineExport() - ולידציה לפני ייצוא
 *   - כולל: מיפוי ערכי רדיו לאקסל, מטא-דאטה לטבלאות, מילון קנוני
 *
 * מי משתמש בקובץ:
 *   - MapperCore.js - כפתור ייצוא
 *   - fill-engine-ui.js - סימולציית מילוי
 *
 * באיזה מצבים:
 *   מצב מיפוי - בייצוא תבנית
 *
 * Singleton: export const fillEngineExporter
 * ═══════════════════════════════════════════════════════════════
 */
