/**
 * ═══════════════════════════════════════════════════════════════
 * תיעוד בעברית - LabelDetectionV2
 * ═══════════════════════════════════════════════════════════════
 *
 * מה הקובץ עושה:
 *   זיהוי חכם של תוויות לצ'קבוקסים וכפתורי רדיו.
 *   כשמשתמש מסמן קבוצת רדיו/צ'קבוקס, המנוע מזהה
 *   אוטומטית את הטקסט שליד כל אפשרות.
 *
 * איך זה עובד:
 *   שלב 1: סריקה בסיסית - LEFT scan 80x24px, חלופה ל-RIGHT
 *   שלב 2: זיהוי גבולות - קיבוץ לפי שורה, מיון RTL
 *   שלב 3: סינון רעש - הסרת טקסט boilerplate
 *   שלב 4: זיהוי כותרת קבוצה אנכית
 *
 * מי משתמש בקובץ:
 *   - DrawController.js - בזרימת קבוצת רדיו
 *   - RadioGroupDialog.js - הצגת תוויות לאישור
 *
 * באיזה מצבים:
 *   מצב מיפוי - בכל הגדרת קבוצת רדיו/צ'קבוקס
 *
 * למה הוא קיים:
 *   כדי שהמשתמש לא יצטרך להקליד ידנית את התוויות
 *   של כל אפשרות בקבוצת רדיו (למשל: "זכר", "נקבה").
 * ═══════════════════════════════════════════════════════════════
 */
