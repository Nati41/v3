/**
 * ═══════════════════════════════════════════════════════════════
 * תיעוד בעברית - RefinerConfig
 * ═══════════════════════════════════════════════════════════════
 *
 * מה הקובץ עושה:
 *   מכיל את כל הפרמטרים של AutoBoxer ו-BboxRefiner.
 *   ערכים אלה כוילו בקפידה על טפסים ממשלתיים בעברית.
 *
 * ערכים חשובים:
 *   - INK_THRESHOLD: 220 - סף לזיהוי "דיו" (כולל גבולות אפורים)
 *   - DEFAULT_WIDTH: 200px - רוחב ברירת מחדל לשדה
 *   - DEFAULT_HEIGHT: 35px - גובה ברירת מחדל לשדה
 *   - MAX_WIDTH: 500px - רוחב מקסימלי
 *
 * מי משתמש בקובץ:
 *   - AutoBoxer.js - פרמטרי זיהוי פיקסלים
 *   - BboxRefiner.js - פרמטרי שיפור מלבנים
 *
 * באיזה מצבים:
 *   כל מצב ציור - ערכים קבועים
 *
 * למה הוא קיים:
 *   ריכוז כל הפרמטרים במקום אחד. מונע "מספרי קסם" בתוך הקוד.
 *
 * אזהרה: אין לשנות ערכים ללא בדיקה מקיפה על טפסים שונים!
 * ═══════════════════════════════════════════════════════════════
 */
