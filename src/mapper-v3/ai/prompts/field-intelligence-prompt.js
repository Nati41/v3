/**
 * ═══════════════════════════════════════════════════════════════
 * תיעוד בעברית - field-intelligence-prompt
 * ═══════════════════════════════════════════════════════════════
 *
 * מה הקובץ עושה:
 *   מכיל את הפרומפט שנשלח ל-AI לזיהוי אינטליגנציית שדות.
 *   AI מקבל את הפרומפט + תמונת PDF ומחזיר JSON עם:
 *   שם קנוני, הקשר, פורמט, סוג נתון - לכל שדה.
 *
 * מי משתמש בקובץ:
 *   - AIService.js - בונה את הבקשה ל-AI
 *
 * באיזה מצבים:
 *   מצב AI - בניתוח אינטליגנציית שדות
 *
 * למה הוא קיים:
 *   הפרדה בין לוגיקת תקשורת (AIService) לבין תוכן הפרומפט.
 * ═══════════════════════════════════════════════════════════════
 */
