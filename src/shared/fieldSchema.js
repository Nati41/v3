/**
 * ═══════════════════════════════════════════════════════════════
 * תיעוד בעברית - fieldSchema
 * ═══════════════════════════════════════════════════════════════
 *
 * מה הקובץ עושה:
 *   ולידציית מבנה שדות - מוודא שכל שדה חוקי לפני שמירה/ייצוא.
 *   תומך בשני פורמטים:
 *   - V2: קואורדינטות PDF מוחלטות (pdfX, pdfY, pdfWidth, pdfHeight)
 *   - V3: bbox מנורמל (0-1) + מספר עמוד
 *
 * מי משתמש בקובץ:
 *   - StateManager.js - ולידציה בהוספת שדה
 *   - TemplateValidator.js - ולידציה לפני ייצוא
 *   - fill-engine.js - ולידציה בטעינת תבנית
 *
 * באיזה מצבים:
 *   תמיד - כל פעולה על שדות עוברת ולידציה
 *
 * למה הוא קיים:
 *   מניעת שדות פגומים שיגרמו לבאגים בהמשך.
 * ═══════════════════════════════════════════════════════════════
 */
